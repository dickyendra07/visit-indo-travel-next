          ...
          <div className="relative z-10 mx-auto flex min-h-[680px] max-w-[1240px] items-center px-6 md:px-10">
            <div className="max-w-4xl">
              ...
              <p className="mt-8 max-w-2xl text-[18px] leading-9 text-white/72">
                From Bali and Java to Papua and the eastern islands, each region
                offers a different rhythm of culture, nature, comfort, and
                discovery.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-[1240px] px-6 md:px-10">
            <div className="mb-14 max-w-3xl">
              ...
              <h2 className="font-display text-[46px] leading-[0.95] tracking-[-0.045em] md:text-[76px]">
                Choose your Indonesia direction.
              </h2>
            </div>
              ...
              {destinations.map((item) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <span className="mt-7 inline-flex text-[11px] font-bold uppercase tracking-[0.18em] text-[#a8782d]">
                      Explore Destination →
                    </span>
                  </div>
                </Link>
